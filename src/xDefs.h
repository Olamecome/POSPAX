...
typedef enum {
	...
	COLLECTIONS, ECR_MENU, CASH_MOP_UP, WALLET_MENU, TERMINAL_REMOTE_DOWNLOAD, EXPORT_LOG, STRESS_TEST, PHED, GATEWAY, COUNT_OF_RECEIPT, SUPERVISOR_PIN_UPDATE, PAYATTITUDE
} TransactionType;
